...
exports.add = (req, res) => {
    ...
    Timeslots.find({ group_id : req.body.group_id })
        .then( data => {
            var conflict = 0;
...
exports.getSingle = (req, res) => {
    Timeslots.find({ _id : req.params.id })
    .then( timeslot => {
...
exports.delete = async (req, res) => {
    ...
    await Timeslots.findOneAndDelete({ _id: req.body.id })
    .then( result => {
...
exports.update = (req, res) => {
    ...
    Timeslots.findOne({_id : req.body.id }, (err, timeslot) => {
